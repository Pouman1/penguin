...
# Conclusion
Overall, my analysis suggests that expanding the use of optional pre-lecture videos could create value for students in COMP 110. The countplot showed that a large amount of students rated pre-lecture videos very highly, with responses concentrated around 5, 6, and 7. This suggests that many students could benefit from these videos. 
...
Based on this analysis, I would recommend that the course expand on the idea of using pre-lecture videos. Creating short videos focused on difficult concepts, common mistakes, and creating practice questions to go with the videos(Sort of like edpuzzle, but not required) could help a lot. 

However, there are also trade-offs to consider. Creating these videos cost time and effort from instructors. Additionally, if too much important content is moved into videos, people who don't watch the "optional videos" will be disadvantaged. 

Even though the analusis suggests support for pre-lecture videos, the data is still observational and based on student opinion instead of learning outcomes. Future analysis could compare student performance data before and after introducing some pre-lecture videos to better prove if the videos actually improve understanding of the course.
